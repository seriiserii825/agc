	...
	<div class="container">
		<div class="row">
			<div class="col-md-5 col-md-offset-1 col-xs-12">
				...
				<h2 class="phone_head"><?php pll_e('Позвоните'); ?>: <a href="tel:<?php the_field('phone', 'options'); ?>"><?php the_field('phone', 'options'); ?></a></h2>
...
?>
				...
				<?php the_field('aress_footer_md', 'options'); ?>
				<?php elseif($currentlang=="en-US"): ?>
				<?php the_field('aress_footer_en', 'options'); ?>
				<?php elseif($currentlang=="ru-RU"): ?>
				<?php the_field('aress_footer', 'options'); ?>
				<?php endif; ?>
				<?php pll_e('Телефон'); ?>: <a href="tel:+373 22 926 162"> +373 22 926 162</a></p>
			</div>
		</div>
			<div class="col-md-5 col-xs-12">
				...
				<?php if($currentlang=="ro-RO"): ?>
				<?php echo do_shortcode('[contact-form-7 id="147" title="Контактная форма md"]'); ?>
				<?php elseif($currentlang=="en-US"): ?>
				<?php echo do_shortcode('[contact-form-7 id="148" title="Контактная форма en"]'); ?>
				<?php elseif($currentlang=="ru-RU"): ?>
